<x-app-layout>
    <x-slot name="header">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="h3 mb-0">Add Customer</h2>
                    ...
                    <form method="POST" action="{{ route('customers.store') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('customer_type') is-invalid @enderror" id="customer_type" name="customer_type" required>
                                    ...
                                    <option value="unregistered" {{ old('customer_type') == 'unregistered' ? 'selected' : '' }}>Unregistered</option>
                                </select>
                                @error('customer_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('ntn_cnic') is-invalid @enderror" 
                                   id="ntn_cnic" name="ntn_cnic" value="{{ old('ntn_cnic') }}">
                            @error('ntn_cnic')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
