<x-app-layout>
    <x-slot name="header">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h2 class="h3 mb-0">Add Item</h2>
                <p class="text-muted mb-0">Create a new product or service item</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <form method="POST" action="{{ route('items.store') }}">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('tax_rate') is-invalid @enderror" id="tax_rate" name="tax_rate" required>
                                    ...
                                    <option value="17" {{ old('tax_rate') == '17' ? 'selected' : '' }}>17% (Standard)</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('sro_references') is-invalid @enderror" 
                                   id="sro_references" name="sro_references" value="{{ old('sro_references') }}"
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check2 me-2"></i>Create Item
                            </button>
                        </div>
                    </form>
                </div>
